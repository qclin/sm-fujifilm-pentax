...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let vcText = storyboard.instantiateViewControllerWithIdentifier("NavController") as! UINavigationController
        vcText.tabBarItem = UITabBarItem(tabBarSystemItem: .History, tag: 2)
        tabBarController.viewControllers?.append(vcText)
        return true
    }
